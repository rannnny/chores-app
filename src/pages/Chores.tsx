  ...
  return (
    <div className="space-y-6 pt-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-slate-900 tracking-tight">등록된 집안일</h2>
        <button
      ...
      {loading ? (
        ...
        <>
          <section>
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">반복 작업</h3>
            {renderList(recurringChores, '등록된 반복 작업이 없어요.')}
          </section>
          <section>
            <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide mb-1">1회성 작업</h3>
