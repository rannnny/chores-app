...
const ghostButton =
  'rounded-lg border border-slate-300 hover:bg-slate-50 hover:border-[#8b5e3c] disabled:opacity-50 text-slate-700 text-sm px-4 py-2 font-medium'
        ...
        <AccordionSection label="닉네임" open={nicknameOpen} onToggle={() => setNicknameOpen((o) => !o)}>
          <div className="space-y-3">
            <input
              ...
              placeholder="닉네임 입력"
              className="w-full rounded-lg border border-slate-200 px-3 py-2.5 outline-none focus:border-[#8b5e3c]"
            />
        ...
        <AccordionSection label="이모지" open={emojiOpen} onToggle={() => setEmojiOpen((o) => !o)}>
          <div className="space-y-3">
            <input
              ...
              placeholder="이모지"
              className="w-full rounded-lg border border-slate-200 px-3 py-2.5 text-xl text-center outline-none focus:border-[#8b5e3c]"
            />
            <div className="flex justify-end">
