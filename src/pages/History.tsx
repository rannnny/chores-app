    ...
    <div className="space-y-4 pt-4">
      ...
      <div className="relative">
        <select
          ...
          className="w-full appearance-none rounded-lg border border-slate-200 pl-3 pr-9 py-2.5 outline-none focus:border-[#8b5e3c] bg-white text-sm text-slate-900"
        >
                    ...
                    {isEditing ? (
                      <div className="flex gap-2 mt-2">
                        <input
                          ...
                          className="flex-1 rounded-lg border border-slate-200 px-3 py-1.5 text-sm outline-none focus:border-[#8b5e3c]"
                        />
                        <button
                          onClick={() => handleSaveMemo(log.id)}
                          className="rounded-lg bg-[#8b5e3c] hover:bg-[#74492d] text-white text-xs px-3 py-1.5 font-medium shrink-0"
                        >
                          저장
                        </button>
                        <button
                  ...
                  {!isEditing && (
                    <div className="flex gap-1.5 text-xs shrink-0">
                      <button
                        ...
                        className="rounded-md border border-slate-200 text-slate-500 hover:border-[#8b5e3c] hover:text-slate-900 px-2 py-1"
                      >
                        메모
                      </button>
                      <button
